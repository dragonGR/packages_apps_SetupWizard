...
package com.aicp.setupwizard.util;
...
import static com.aicp.setupwizard.SetupWizardApp.KEY_DETECT_CAPTIVE_PORTAL;
...
public class SetupWizardUtils {
    ...
    private static final String UPDATER_PACKAGE = "com.aicp.updater3";
    ...
    public static boolean hasGMS(Context context) {
        ...
        if (PackageUtils.isPackageInstalled(context, GMS_PACKAGE) &&
                PackageUtils.isPackageInstalled(context, gmsSuwPackage)) {
            PackageManager packageManager = context.getPackageManager();
            if (LOGV) {
