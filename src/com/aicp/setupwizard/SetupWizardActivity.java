...
public class SetupWizardActivity extends BaseSetupWizardActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (SetupWizardUtils.hasGMS(this)) {
            ...
            if (isPrimaryUser()) {
                intent.putExtra(EXTRA_SCRIPT_URI, getString(R.string.aicp_wizard_script_uri));
            } else {
                intent.putExtra(EXTRA_SCRIPT_URI, getString(R.string.aicp_wizard_script_user_uri));
            }
